...
public class Hendelse implements Serializable{
	...
	public String toString() {
		return "Hendelse: " + beskrivelse + "\nStarter: " + 
				startDato.toString() + " og slutter: " + sluttDato.toString();
	}
	 ...
	 * ogs� oppgave j) og en del av oppgave k) 
	 */
	...
	public void fjernPerson(Person personen){
		invitertePersoner.remove(personen);
		if(!personen.invitertTilHendelse(this)) personen.fjernHendelse(this);
	}
	
	public ArrayList<Person> getInvitertePersoner() {
